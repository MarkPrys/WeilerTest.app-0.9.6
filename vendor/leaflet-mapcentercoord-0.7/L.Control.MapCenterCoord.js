L.Control.MapCenterCoord = L.Control.extend({
  ...
  onAdd: function (map) {
    if (this.options.icon) {
      ...
      //fb: map.getPanes().overlayPane.appendChild(this._iconEl);
      map.getPanes().shadowPane.appendChild(this._iconEl);
  ...
  onRemove: function (map) {
    ...
    if (this.options.icon) {
      //fb: map.getPanes().overlayPane.removeChild(this._iconEl);
      map.getPanes().shadowPane.removeChild(this._iconEl);
  ...
  _getLatLngCoord: function (center) {
    ...
    if (this.options.latlngFormat === "DM") {
      ...
      lng =
        deg + "º " + this._format("00", parseInt(min)) + "' " + this._format("00.0", (min - parseInt(min)) * 60) + "''";
      deg = parseInt(center.lat);
